...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4 class="page-title">Product Discount</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/">Home</a></li>
                <li class="breadcrumb-item"><a href="#">View Product Discount</a></li>
            </ol>
        ...
        <div class="col-12">
            <div class="card-box">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <a href="/sell/discount/create" class="btn btn-sm btn-primary pull-right"><i
                                ...
                                <td>
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item"
                                           href="/sell/discount/edit/{{$res->discount_id}}"><i
                                                    class="fa fa-edit"></i> Edit</a>
                                        <a class="dropdown-item"
                                           href="/sell/discount/destroy/{{$res->discount_id}}"><i
