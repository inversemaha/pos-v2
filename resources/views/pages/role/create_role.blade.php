...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">New User Role</a></li>
            </ol>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title">New User Role</h4>
                <hr>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="p-20">
                            <form class="form-horizontal" method="post" action="/user/role/store"
